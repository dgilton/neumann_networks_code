...
from src.learned_component_resnet_nblock_small import nblock_resnet
import os, sys, time
...
######################################################
class GradientDescentNet(object):
    def __init__(self, forward_gramian, corruption_model, forward_adjoint, iterations, image_dimension, batch_size,
        ...
        for ii in range(iterations):
            linear_component = runner - self.eta * forward_gramian(runner) + network_input
            if tf.test.gpu_device_name():
